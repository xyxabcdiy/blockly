    ...
    this.borderRect_ = Blockly.utils.createSvgElement('rect',
        {
            ...
            'y': 0,
            'height': Blockly.BlockSvg.MIN_BLOCK_Y - 10
        }, this.fieldGroup_, this.sourceBlock_.workspace);
    /** @type {!Element} */
    this.textElement_ = Blockly.utils.createSvgElement('text',
        {'class': 'blocklyText', 'y': this.size_.height - Blockly.BlockSvg.MIN_BLOCK_Y / 2},
        this.fieldGroup_);
...
Blockly.Field.prototype.getDisplayText_ = function () {
    ...
    if (!text) {
        ...
        return Blockly.Field.NBSP + Blockly.Field.NBSP + Blockly.Field.NBSP;
    }
    ...
    return Blockly.Field.NBSP + Blockly.Field.NBSP + text + Blockly.Field.NBSP + Blockly.Field.NBSP;
};
