...
Blockly.Toolbox.prototype.addColour_ = function (opt_tree) {
    ...
    for (var i = 0, child; child = children[i]; i++) {
        ...
        if (element) {
            if (this.hasColours_ && !(child instanceof Blockly.Toolbox.TreeSeparator)) {
...
Blockly.Toolbox.TreeControl.prototype.setSelectedItem = function (node) {
    ...
    if (node == this.selectedItem_ || node == toolbox.tree_ || node instanceof Blockly.Toolbox.TreeSeparator) {
        return;
    }
